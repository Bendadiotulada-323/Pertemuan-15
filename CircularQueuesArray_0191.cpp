 ...
 * @date 2026-06-08
 * 
 * @copyright bend.adio.ft25@mail.umy.ac.id
 */
...
private:
     ...
     * data dimasukan dalam variable quarry_array
     */
 ...
 * data dihapuskan dalam variable quarry_array 
 */
 ...
 * data ditampilkan dalam variable quarry_array 
 */


    void display() {
        int FRONT_Position = FRONT; ///< variable front_position untuk menandakan posisi elemen pertama pada variable front
        int REAR_Position = REAR; ///< variable rear_position untuk menandakan posisi elemen terkhir pada variable rear
